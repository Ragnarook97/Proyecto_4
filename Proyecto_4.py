...
# #Se le dan opciones de que desea ver del pokemon
# print(f"""Felicidades, encontramos a {pokemon}
# 1. Imagen
# 2. Peso y tamaño
# 3. Movimientos, habilidades y tipo de pokemon""")
# while True:
#     opcion = input(f"¿Qué deseas ver de {pokemon}?: ")
#     #Mostrar una imagen del pokemon
#     if opcion == "1":
#         try: 
#             url_imagen = datos["sprites"]["front_default"]
...
#         break
#     else:
#         print("Opción incorrecta. Por favor ingresa un número entre 1, 2 o 3.")
